...
//içine atılan kelimeden ihtibaren alır.
$sonuc=strstr($ifade,"sınıflar");
echo"strstr1:".$sonuc."<br/>";

//bu şeklide sınıflardan öncesimi alıyor.
$sonuc=strstr($ifade,"sınıflar",true);
echo "strstr2:".$sonuc."<br/>";

//substr
$parca=substr($ifade,0,13);//metin başlangıç uzunluk
...
echo "mb_substr:".$parca."<br/>";

//string pozisyonu
$kitap="Web Tasarımı Kılavuzu";
if(($index=mb_strpos($kitap,"ıl",0,"UTF-8"))===false)//ilk elemanı O
    echo $index."<br/>";
else
    echo  $index."<br>";

//string ters pozisyonu
if(($index=mb_strrpos($kitap,"a","0","UTF-8")))
...
$meyveler="armut kiraz vişne kavun musmula arkadas";
echo wordwrap($meyveler,5,", ")."<br/>";

//str_replace
//the yerine two getirir
...
echo number_format($toplamtutar,5,",",".");

...
$kitaplar[]="Dreamweawer";

print_r($kitaplar);//arryi yadırır.
echo"<pre/>";
//<pre> etiketi önceden biçimlendirilmiş metin tanımlar.Satır sonlar ve boşluklar korunur.
print_r($kitaplar);
echo "</pre>";
...
//arrylerin  index numaralarını ddöndürürüyor.
echo "<pre>";
...
if(array_key_exists('1',$hayvanlar)) // 0 a bak
...
print_r($meyveler);
echo '</pre>';
$meyveler=array_reverse($meyveler);
echo '<pre>';
print_r($meyveler);
echo '</pre>';

//dizi birleştirme
$dizibirlesimi1=array_merge($hayvanlar,$meyveler,$kitaplar,$sebzeler);
echo '<pre>';
...
//hangi değerden kaç tane var  İSTATİSTİK İÇİN ÖNEMLİ
...
$dizibirlestirme=array_combine($sebzeler,$meyveler);//ilk değer indisi ikinci değer ona karşılık gelen değeri veriyor.
echo '<pre>';
...
//282-286 arasını yorum satırından çıkarınca aşağıdakinin sonucu tamamen Androd oluyor Çünkü ustte kitaplara Android diye atanmışoldu.
...
//diziden rastgele değer seçme// random olayını anlayamadım

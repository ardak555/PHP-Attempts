...
for($i=0;$i<10;$i++)
    echo $i."<br/>";
for($i=10;$i>0;$i--)
    echo  '<font size="'.$i.'">PHP</font><br/>';//font size 7 den başladığı için 4 tane aynı büyüklükte PHP yazar.
...
$dizi=explode(" ",$cumle);//fonksiyonunu bir değişken içindeki verileri belirlenen belirtece göre ayırmayı sağlayan fonksiyondur.
